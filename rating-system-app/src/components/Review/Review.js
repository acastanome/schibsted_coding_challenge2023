		...
		return (
			<div className='container'>
				<div className='review-card review-form'>
					<div className='review-card__title'>What was the problem?</div>
					<div>
						<input type='checkbox' id='no_show' name='no_show' />
						<label forhtml='no_show'>They didn't show up</label>
					</div>
					<div>
						<input
							type='checkbox'
							id='not_as_expected'
							name='not_as_expected'
						/>
						<label forhtml='not_as_expected'>Product wasn't as expected</label>
					</div>
					<div>
						<input type='checkbox' id='late' name='late' />
						<label forhtml='late'>They were late</label>
					</div>
					<div>
						<input type='checkbox' id='unpleasant' name='unpleasant' />
						<label forhtml='unpleasant'>They were unpleasant</label>
					</div>
					<textarea placeholder='Other' />

					<div className='review-card__send-btn'>
						<div className='btn' onClick={() => handleReview()}>
							send
						</div>
					</div>
				</div>
		...
		return (
			<div className='container'>
				<div className='review-card'>
					<div className='review-card__title'>How did it go?</div>
